...
vim.api.nvim_create_autocmd("LspAttach", {
  callback = function(args)
    wk.add {
      ...
      { "<leader>ld", function() snacks.picker.lsp_definitions() end, desc = "LSP: Goto Definition" },
      { "<leader>lD", function() snacks.picker.lsp_declarations() end, desc = "LSP: Goto Declaration" },
